 ...
 */
public class Registrar_4_Frag extends Fragment {

    View UI;
    ImageView imageViewPlanta;
    Button buttonGuardarPlanta;

    public Registrar_4_Frag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        UI = inflater.inflate(R.layout.frag_registrar_4, container, false);

        // Se inicializan los elementos del fragment

        imageViewPlanta = UI.findViewById(R.id.imgVplantaR);
        buttonGuardarPlanta = UI.findViewById(R.id.btnGuardarPlanta);

        // Si la variable de imagen no esta vacia

        if (Globales.comprobarCadenaVacia(Globales.getPlanta_actual().getImagenPlanta())){ // Si no esta vacia
        ...
        buttonGuardarPlanta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(Globales.comprobarVariablesVacias()){ // Se comprueba que no existan campos vacios
                    ...
                    mensaje = getActivity().getString(R.string.mensaje_toast_agregar_plantas_exito);

                    Globales.setPlanta_actual(new Planta()); // Se inicializa la variable global
                    Globales.setNumeroRegistros(Globales.getNumeroRegistros()+1); // Se aumenta el valor de la variable
                    ...
                    mensaje = getActivity().getString(R.string.mensaje_toast_agregar_plantas_error);
